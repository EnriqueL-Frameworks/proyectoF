  ...
  <div class="mb-3">
    <div class="input-group is-invalid">
      <div class="input-group-prepend">
        <label class="input-group-text" for="validatedInputGroupSelect"> Propuesta </label>
      </div>
      <select class="custom-select" id="validatedInputGroupSelect" required>
        <option value=""> Propuesta 1 </option>
        <option value="1"> Propuesta 2 </option>
        <option value="2"> Propuesta 3 </option>
        <option value="3"> Propuesta 4 </option>
      </select>
    </div>
    <div class="invalid-feedback">

    Propuesta a Actualizar
...
<div class="form-group">
  ...
  <small id="emailHelp" class="form-text text-muted">Escribe aqui el nombre del producto.</small>
</div>
...
<br>
 ...
 <div class="form-group">
    ...
    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
    <small id="emailHelp" class="form-text text-muted">Escribe aqui la descripcion del producto.</small>
  </div>
