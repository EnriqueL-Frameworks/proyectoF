        ...
        <div class="card rounded-0">
          <div class="card-body">
              ...
              <div class="form-group">
                ...
                <small id="emailHelp" class="form-text text-muted">Ingresa el nuevo ID de la categoria .</small>
              </div>

              <div class="form-group">
                <label for="exampleInputEmail1">Nombre </label>
                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                <small id="emailHelp" class="form-text text-muted">Ingresa el nuevo  nombre de la categoria.</small>
              </div>

              <div class="col-lg-3 d-flex">
                <button type="button" class="btn btn-primary w-100 align-self-center"> Actualizar Categoria</button>
             </div>
