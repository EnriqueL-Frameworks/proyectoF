      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 d-flex">
             <a button type="button" href="/supervisor/AltUsuario"  class="btn btn-primary w-100 align-self-center">Alta Usuario</button></a>
              ...
              <table class="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Contador</td>
                    <td>Juan M</td>
                    <td>juan@outlook.com</td>
                    <td>
              <a href="/supervisor/VerUsuario" type="button" class="btn btn-info">Ver</a>
              <a href="/supervisor/usuario/editar" type="button" class="btn btn-warning">Editar</a>
