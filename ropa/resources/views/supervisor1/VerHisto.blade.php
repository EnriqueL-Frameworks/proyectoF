...
<div class="form-group">
<label for="exampleInputEmail1">Fecha de Publicasion.</label>
<input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
</div>

<br>
<div class="form-group">
<label for="exampleInputEmail1">Numero de Preguntas al Vendedor</label>
<input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
</div>
...
<p class="text-right">
<a href="/supervisor/Histori" button type="submit" class="btn btn-primary mb-2">Regresar </button>
    </section>
