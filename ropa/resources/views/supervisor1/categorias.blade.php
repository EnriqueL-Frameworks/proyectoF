      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 d-flex">
             <a button type="button" href="/supervisor/AgregarCate" class="btn btn-primary w-100 align-self-center"> Nueva categoria</button> </a>
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Dama</td>
                      <td>
                        <a href="/supervisor/VerCate" button type="button" class="btn btn-info">Ver</button></a>
                        
                        <a href="/supervisor/EditCate" button type="button" class="btn btn-warning">Editar</button></a>
