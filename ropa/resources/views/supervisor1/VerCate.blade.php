    ...
    <section class="bg-mix">
      <div class="container">
        <div class="card rounded-0">
          <div class="card-body">
              <h4>Vista Categoria</h4>


              <div class="form-group">
                <label for="exampleInputEmail1"> ID </label>
                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                <small id="emailHelp" class="form-text text-muted">ID de la categoria .</small>
              </div>
              ...
              <div class="col-lg-3 d-flex">
                <a button type="button" href="/supervisor/categorias" class="btn btn-primary w-100 align-self-center"> Regresar a Categorias</button> </a>
             </div>
