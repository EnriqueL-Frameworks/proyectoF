...
<div class="form-group mx-sm-3 mb-2">
<label for="inputPassword2" class="sr-only">Password</label>
<input type="txt" class="form-control" id="inputPassword2" placeholder="Dama">
</div>
...
<div class="form-group mx-sm-3 mb-2">
<label for="inputPassword2" class="sr-only">Password</label>
<input type="txt" class="form-control" id="inputPassword2" placeholder="Cuantos">
</div>
</form>
...
<form class="form-inline">
<div class="form-group mb-2">
    <td> <img src="../imagenes/caballero/playeras/pc8.jpg" class="ml-3" alt="..." width="400px"> </td>
...
<a href="/supervisor/Produc" button type="submit" class="btn btn-primary mb-2">Regresar </button>
