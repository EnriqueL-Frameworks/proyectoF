        ...
        <div class="card rounded-0">
          <div class="card-body">
              ...
              <div class="form-group">
                ...
                <small id="emailHelp" class="form-text text-muted">Ingresa la ID del Usuario .</small>
              </div>

              <div class="form-group">
                <label for="exampleFormControlSelect1">Seleccione el Roll</label>
                <select class="form-control" id="exampleFormControlSelect1">
                  <option>Contador </option>
                  <option>Super Visor</option>
              ...
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                <small id="emailHelp" class="form-text text-muted">Ingresa el nombre del Nuevo Usuario.</small>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                <small id="emailHelp" class="form-text text-muted">Ingresa el Correo Electronico del Usuario.</small>
              </div>
              <Br>
              </div>
              <div class="col">
            ...
            <br>
              ...
              <div class="col-lg-3 d-flex">
                ...
                <button type="button" class="btn btn-primary w-100 align-self-center"> Agregar Usuario</button>
             </div>
