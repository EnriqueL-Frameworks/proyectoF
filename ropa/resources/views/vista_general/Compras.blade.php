...
<div id="content">
            <section class="p-y3">
              <div class="container">
                <div class="row">
                  <div class="col-lg-9">
                    <h1 class="font-weight-bold mb-0"> Carrito de Compras. </h1>
                  </div>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    <input type="number" class="btn btn-primary" value="1" id="quantity" name="quantity" min="1" max="10">
...
<br>
  ...
  <a button href="/Calificar" type="submit" class="btn btn-primary mb-2">Confirmar compra.</button> <a>
